...
task_check_platform_dependency_pins() {
  ...
  local helmfile_file="deploy/platform/helmfile.yaml.gotmpl"
  local values_file="deploy/platform/values/defaults.yaml"
