...
Release candidates and stable releases use the same gates, covering all four
images and their immutable release records.
...
Keep credentials and signed URLs out of release notes and public CI artefacts.
