...
The Job does not restart a failed TAMSin process. TAMSin retries safe HTTP
operations within the attempt; replaying the whole ingest can repeat media
writes. Check the previous attempt's output before requesting another run.
