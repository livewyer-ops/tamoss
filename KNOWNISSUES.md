...
Dependabot coverage added in #188. Findings and scanner errors fail
`task security:audit` by default; this list is not a release-gate exception.
...
end state is for `task security:audit` to pass without exceptions.
